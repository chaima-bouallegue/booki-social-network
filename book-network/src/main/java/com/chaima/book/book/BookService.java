package com.chaima.book.book;

import com.chaima.book.common.PageResponse;
import com.chaima.book.exception.OperationNotPermittedException;
import com.chaima.book.file.FileStorageService;
import com.chaima.book.history.BookTransactionHistory;
import com.chaima.book.history.BookTransactionHistoryRepository;
...
import static com.chaima.book.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public void uploadBookCoverPicture(MultipartFile file, Authentication connectedUser, Integer bookId) {
        Book book = bookRepository.findById(bookId)
                .orElseThrow(() -> new EntityNotFoundException("No book found with ID:: " + bookId));
        User user = ((User) connectedUser.getPrincipal());
        var profilePicture = fileStorageService.saveFile(file, String.valueOf(user.getId())); // Correction : Conversion en String
